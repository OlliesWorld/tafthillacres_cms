...
const NewContactForm = (props) => {
  ...
  return (
    <div className="container grid grid-cols-2 h-half w-3/5 bg-bg-light m-auto mb-4 py-4 px-12">
    <form data-netlify="true" action="/" name="contactUs" method="post" onSubmit={handleSubmit} className="w-full">
     {/* <label htmlFor="nameInput" className="text-4xl text-dark-tan mb-2 w-full font-bold">Send us a Message</label> */}
      <input type="hidden" name="form-name" value="contact-form" />
        ...
        <textarea className='w-80' placeholder='Message' name='message' rows='8' minlength="8" onChange={handleChange} required />
